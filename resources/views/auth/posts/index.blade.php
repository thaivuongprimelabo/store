        ...
        <div class="col-xs-12">
          <div class="box">
              ...
              <div class="box-body">
                 ...
                 <div class="col-md-6">
                    <button type="button" id="search" class="btn btn-warning pull-left" onclick="window.location='{{ route('auth_posts_create') }}'">{{ trans('auth.button.create') }}</button>
                  </div>
                 <div class="col-md-6">
                    <button type="button" id="search" class="btn btn-primary pull-right" data-url="{{ route('auth_posts_search') }}">{{ trans('auth.button.search') }}</button>
                  </div>
              </div>
          </div>
          @if (session('success'))
