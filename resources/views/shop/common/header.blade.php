...
<header id="header">
	<div class="row">
		<div class="span4">
			<h1>
				<a class="logo" href="index.html"><span>Twitter Bootstrap
					...
					src="{{ url('shop/assets/img/logo-bootstrap-shoping-cart.png') }}"
		...
		<div class="span4 alignR">
			<p>
				<br> <strong> {{ trans('shop.support') }} : 0800 1234 678 </strong><br>
				<br>
			</p>
			<span class="btn btn-warning btn-mini">VN</span> 
